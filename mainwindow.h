...
public slots:
    ...
    void slotProcessRcvDFZRegData(QList<quint16>);
...
const QString MDFZModbusregisters[144] = {
    "ВВОД ВЧЗЛ",
    "ВВОД ТДЗ",
    "ПУСК ДФЗ",
    "РАБОТА ДФЗ",
    ...
    "АК№1 ОТ ЗНР",
    "ОСТАНОВ ОТ ЗНР",
    "БЛОК СТУП 3 ТЗНП ОТ ЗНР",
    "БЛОК СТУП 4 ТЗНП ОТ ЗНР",
    "КОМПАР НЗНР",
    "РАБОТА НЗНР",
    "ОТКЛ Q ОТ НЗНР",
    "БЛОК СТУП 3 ТЗНП ОТ НЗНР",
    "БЛОК СТУП 4 ТЗНП ОТ НЗНР",
    "Резерв",
    "Ввод УРОВ",
    "компар фазы А",
    "компар фазы В",
    ...
    "Резерв",
    "Ввод ДЗ",
    "ввод быстрых ступ ДЗ",
    "ввод медленных ступ ДЗ",
    "ПО 1 ступени ДЗ",
    "ПО 2 ступени ДЗ",
    "ПО 3 ступени ДЗ",
    "Работа 1 ступ ДЗ с нулём",
    "Работа 1 ступ ДЗ",
    "Работа 2 ступ ДЗ (быстр)",
    "Работа 2 ступ ДЗ (медл)",
    "Работа 3 ступ ДЗ",
    "Работа ДЗ с АУ",
    "Работа ДЗ с ОУ",
    "Работа ДЗ",
